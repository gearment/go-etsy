...
// checks if the ShopReceiptTransactions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopReceiptTransactions{}
...
type _ShopReceiptTransactions ShopReceiptTransactions
...
type NullableShopReceiptTransactions struct {
	value *ShopReceiptTransactions
	isSet bool
}

func (v NullableShopReceiptTransactions) Get() *ShopReceiptTransactions {
	return v.value
}

func (v *NullableShopReceiptTransactions) Set(val *ShopReceiptTransactions) {
	v.value = val
	v.isSet = true
}

func (v NullableShopReceiptTransactions) IsSet() bool {
	return v.isSet
}

func (v *NullableShopReceiptTransactions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShopReceiptTransactions(val *ShopReceiptTransactions) *NullableShopReceiptTransactions {
	return &NullableShopReceiptTransactions{value: val, isSet: true}
}
