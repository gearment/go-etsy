...
- Build date: 2026-02-10T17:29:29.012175+07:00[Asia/Ho_Chi_Minh]
...
*ShopListingPersonalizationAPI* | [**DeleteListingPersonalization**](docs/ShopListingPersonalizationAPI.md#deletelistingpersonalization) | **Delete** /v3/application/shops/{shop_id}/listings/{listing_id}/personalization | 
*ShopListingPersonalizationAPI* | [**GetListingPersonalization**](docs/ShopListingPersonalizationAPI.md#getlistingpersonalization) | **Get** /v3/application/listings/{listing_id}/personalization | 
*ShopListingPersonalizationAPI* | [**UpdateListingPersonalization**](docs/ShopListingPersonalizationAPI.md#updatelistingpersonalization) | **Post** /v3/application/shops/{shop_id}/listings/{listing_id}/personalization | 
...
## Documentation For Models
 ...
 - [ConsolidateShopReturnPoliciesRequest](docs/ConsolidateShopReturnPoliciesRequest.md)
 - [CreateDraftListingRequest](docs/CreateDraftListingRequest.md)
 ...
 - [CreateReceiptShipmentRequest](docs/CreateReceiptShipmentRequest.md)
 - [CreateShopReadinessStateDefinitionRequest](docs/CreateShopReadinessStateDefinitionRequest.md)
 - [CreateShopReadinessStateDefinitionRequestProcessingTimeUnit](docs/CreateShopReadinessStateDefinitionRequestProcessingTimeUnit.md)
 - [CreateShopReadinessStateDefinitionRequestReadinessState](docs/CreateShopReadinessStateDefinitionRequestReadinessState.md)
 - [CreateShopReturnPolicyRequest](docs/CreateShopReturnPolicyRequest.md)
 - [CreateShopSectionRequest](docs/CreateShopSectionRequest.md)
 - [CreateShopShippingProfileDestinationRequest](docs/CreateShopShippingProfileDestinationRequest.md)
 - [CreateShopShippingProfileRequest](docs/CreateShopShippingProfileRequest.md)
 ...
 - [CreateShopShippingProfileUpgradeRequest](docs/CreateShopShippingProfileUpgradeRequest.md)
 ...
 - [EtsyModulesListingPersonalizationApiResourcesOpenApiListingPersonalization](docs/EtsyModulesListingPersonalizationApiResourcesOpenApiListingPersonalization.md)
 - [EtsyModulesListingPersonalizationApiResourcesOpenApiPersonalizationQuestion](docs/EtsyModulesListingPersonalizationApiResourcesOpenApiPersonalizationQuestion.md)
 - [EtsyModulesListingPersonalizationApiResourcesOpenApiPersonalizationQuestionOptionsInner](docs/EtsyModulesListingPersonalizationApiResourcesOpenApiPersonalizationQuestionOptionsInner.md)
 ...
 - [ShopProcessingProfile](docs/ShopProcessingProfile.md)
 - [ShopProcessingProfiles](docs/ShopProcessingProfiles.md)
 ...
 - [TokenScopesRequest](docs/TokenScopesRequest.md)
 ...
 - [UpdateHolidayPreferencesRequest](docs/UpdateHolidayPreferencesRequest.md)
 ...
 - [UpdateListingPersonalizationRequest](docs/UpdateListingPersonalizationRequest.md)
 - [UpdateListingPersonalizationRequestPersonalizationQuestionsInner](docs/UpdateListingPersonalizationRequestPersonalizationQuestionsInner.md)
 - [UpdateListingPersonalizationRequestPersonalizationQuestionsInnerOptionsInner](docs/UpdateListingPersonalizationRequestPersonalizationQuestionsInnerOptionsInner.md)
 - [UpdateListingPersonalizationRequestPersonalizationQuestionsInnerQuestionType](docs/UpdateListingPersonalizationRequestPersonalizationQuestionsInnerQuestionType.md)
 - [UpdateListingPropertyRequest](docs/UpdateListingPropertyRequest.md)
 ...
 - [UpdateListingRequestState](docs/UpdateListingRequestState.md)
 - [UpdateListingRequestType](docs/UpdateListingRequestType.md)
 - [UpdateListingTranslationRequest](docs/UpdateListingTranslationRequest.md)
 - [UpdateShopReadinessStateDefinitionRequest](docs/UpdateShopReadinessStateDefinitionRequest.md)
 - [UpdateShopReceiptRequest](docs/UpdateShopReceiptRequest.md)
 - [UpdateShopRequest](docs/UpdateShopRequest.md)
 - [UpdateShopShippingProfileDestinationRequest](docs/UpdateShopShippingProfileDestinationRequest.md)
 - [UpdateShopShippingProfileRequest](docs/UpdateShopShippingProfileRequest.md)
 - [UpdateShopShippingProfileUpgradeRequest](docs/UpdateShopShippingProfileUpgradeRequest.md)
