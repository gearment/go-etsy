...
// checks if the ListingVariationImage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListingVariationImage{}
...
type _ListingVariationImage ListingVariationImage
...
type NullableListingVariationImage struct {
	value *ListingVariationImage
	isSet bool
}

func (v NullableListingVariationImage) Get() *ListingVariationImage {
	return v.value
}

func (v *NullableListingVariationImage) Set(val *ListingVariationImage) {
	v.value = val
	v.isSet = true
}

func (v NullableListingVariationImage) IsSet() bool {
	return v.isSet
}
...
func NewNullableListingVariationImage(val *ListingVariationImage) *NullableListingVariationImage {
	return &NullableListingVariationImage{value: val, isSet: true}
}
