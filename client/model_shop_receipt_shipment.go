...
// checks if the ShopReceiptShipment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopReceiptShipment{}
...
type _ShopReceiptShipment ShopReceiptShipment
...
type NullableShopReceiptShipment struct {
	value *ShopReceiptShipment
	isSet bool
}

func (v NullableShopReceiptShipment) Get() *ShopReceiptShipment {
	return v.value
}

func (v *NullableShopReceiptShipment) Set(val *ShopReceiptShipment) {
	v.value = val
	v.isSet = true
}

func (v NullableShopReceiptShipment) IsSet() bool {
	return v.isSet
}
...
func NewNullableShopReceiptShipment(val *ShopReceiptShipment) *NullableShopReceiptShipment {
	return &NullableShopReceiptShipment{value: val, isSet: true}
}
