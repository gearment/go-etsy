...
func (r SellerTaxonomyAPIGetPropertiesByTaxonomyIdRequest) Execute() (*TaxonomyNodeProperties, *http.Response, error) {
	return r.ApiService.GetPropertiesByTaxonomyIdExecute(r)
}
...
Retrieves a list of product properties, with applicable scales and values, supported for a specific seller taxonomy ID.
	...
	@return SellerTaxonomyAPIGetPropertiesByTaxonomyIdRequest
*/
func (a *SellerTaxonomyAPIService) GetPropertiesByTaxonomyId(ctx context.Context, taxonomyId int64) SellerTaxonomyAPIGetPropertiesByTaxonomyIdRequest {
	return SellerTaxonomyAPIGetPropertiesByTaxonomyIdRequest{
		ApiService: a,
		ctx:        ctx,
...
//
//	@return TaxonomyNodeProperties
func (a *SellerTaxonomyAPIService) GetPropertiesByTaxonomyIdExecute(r SellerTaxonomyAPIGetPropertiesByTaxonomyIdRequest) (*TaxonomyNodeProperties, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *TaxonomyNodeProperties
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SellerTaxonomyAPIService.GetPropertiesByTaxonomyId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/application/seller-taxonomy/nodes/{taxonomy_id}/properties"
	localVarPath = strings.Replace(localVarPath, "{"+"taxonomy_id"+"}", url.PathEscape(parameterValueToString(r.taxonomyId, "taxonomyId")), -1)
...
func (r SellerTaxonomyAPIGetSellerTaxonomyNodesRequest) Execute() (*SellerTaxonomyNodes, *http.Response, error) {
	return r.ApiService.GetSellerTaxonomyNodesExecute(r)
}
...
Retrieves the full hierarchy tree of seller taxonomy nodes.
	...
	@return SellerTaxonomyAPIGetSellerTaxonomyNodesRequest
*/
func (a *SellerTaxonomyAPIService) GetSellerTaxonomyNodes(ctx context.Context) SellerTaxonomyAPIGetSellerTaxonomyNodesRequest {
	return SellerTaxonomyAPIGetSellerTaxonomyNodesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return SellerTaxonomyNodes
func (a *SellerTaxonomyAPIService) GetSellerTaxonomyNodesExecute(r SellerTaxonomyAPIGetSellerTaxonomyNodesRequest) (*SellerTaxonomyNodes, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SellerTaxonomyNodes
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SellerTaxonomyAPIService.GetSellerTaxonomyNodes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/application/seller-taxonomy/nodes"
