...
// checks if the ListingPropertyValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListingPropertyValue{}
...
type _ListingPropertyValue ListingPropertyValue
...
type NullableListingPropertyValue struct {
	value *ListingPropertyValue
	isSet bool
}

func (v NullableListingPropertyValue) Get() *ListingPropertyValue {
	return v.value
}

func (v *NullableListingPropertyValue) Set(val *ListingPropertyValue) {
	v.value = val
	v.isSet = true
}

func (v NullableListingPropertyValue) IsSet() bool {
	return v.isSet
}
...
func NewNullableListingPropertyValue(val *ListingPropertyValue) *NullableListingPropertyValue {
	return &NullableListingPropertyValue{value: val, isSet: true}
}
