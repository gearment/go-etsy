...
// checks if the ShippingCarriers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingCarriers{}
...
type _ShippingCarriers ShippingCarriers
...
func (v NullableShippingCarriers) Get() *ShippingCarriers {
	return v.value
}

func (v *NullableShippingCarriers) Set(val *ShippingCarriers) {
	v.value = val
	v.isSet = true
}
...
func NewNullableShippingCarriers(val *ShippingCarriers) *NullableShippingCarriers {
	return &NullableShippingCarriers{value: val, isSet: true}
}
