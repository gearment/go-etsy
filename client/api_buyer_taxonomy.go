...
func (r BuyerTaxonomyAPIGetBuyerTaxonomyNodesRequest) Execute() (*BuyerTaxonomyNodes, *http.Response, error) {
	return r.ApiService.GetBuyerTaxonomyNodesExecute(r)
}
...
Retrieves the full hierarchy tree of buyer taxonomy nodes.
	...
	@return BuyerTaxonomyAPIGetBuyerTaxonomyNodesRequest
*/
func (a *BuyerTaxonomyAPIService) GetBuyerTaxonomyNodes(ctx context.Context) BuyerTaxonomyAPIGetBuyerTaxonomyNodesRequest {
	return BuyerTaxonomyAPIGetBuyerTaxonomyNodesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return BuyerTaxonomyNodes
func (a *BuyerTaxonomyAPIService) GetBuyerTaxonomyNodesExecute(r BuyerTaxonomyAPIGetBuyerTaxonomyNodesRequest) (*BuyerTaxonomyNodes, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *BuyerTaxonomyNodes
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BuyerTaxonomyAPIService.GetBuyerTaxonomyNodes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/application/buyer-taxonomy/nodes"
...
func (r BuyerTaxonomyAPIGetPropertiesByBuyerTaxonomyIdRequest) Execute() (*BuyerTaxonomyNodeProperties, *http.Response, error) {
	return r.ApiService.GetPropertiesByBuyerTaxonomyIdExecute(r)
}
...
//
//	@return BuyerTaxonomyNodeProperties
func (a *BuyerTaxonomyAPIService) GetPropertiesByBuyerTaxonomyIdExecute(r BuyerTaxonomyAPIGetPropertiesByBuyerTaxonomyIdRequest) (*BuyerTaxonomyNodeProperties, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *BuyerTaxonomyNodeProperties
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BuyerTaxonomyAPIService.GetPropertiesByBuyerTaxonomyId")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/application/buyer-taxonomy/nodes/{taxonomy_id}/properties"
