...
// checks if the SellerTaxonomyNode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SellerTaxonomyNode{}
...
type _SellerTaxonomyNode SellerTaxonomyNode
...
type NullableSellerTaxonomyNode struct {
	value *SellerTaxonomyNode
	isSet bool
}

func (v NullableSellerTaxonomyNode) Get() *SellerTaxonomyNode {
	return v.value
}

func (v *NullableSellerTaxonomyNode) Set(val *SellerTaxonomyNode) {
	v.value = val
	v.isSet = true
}
...
func NewNullableSellerTaxonomyNode(val *SellerTaxonomyNode) *NullableSellerTaxonomyNode {
	return &NullableSellerTaxonomyNode{value: val, isSet: true}
}
