...
// checks if the TransactionReviews type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionReviews{}
...
type _TransactionReviews TransactionReviews
...
type NullableTransactionReviews struct {
	value *TransactionReviews
	isSet bool
}

func (v NullableTransactionReviews) Get() *TransactionReviews {
	return v.value
}

func (v *NullableTransactionReviews) Set(val *TransactionReviews) {
	v.value = val
	v.isSet = true
}
...
func NewNullableTransactionReviews(val *TransactionReviews) *NullableTransactionReviews {
	return &NullableTransactionReviews{value: val, isSet: true}
}
