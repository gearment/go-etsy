...
// checks if the TaxonomyPropertyValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaxonomyPropertyValue{}
...
type _TaxonomyPropertyValue TaxonomyPropertyValue
...
type NullableTaxonomyPropertyValue struct {
	value *TaxonomyPropertyValue
	isSet bool
}

func (v NullableTaxonomyPropertyValue) Get() *TaxonomyPropertyValue {
	return v.value
}

func (v *NullableTaxonomyPropertyValue) Set(val *TaxonomyPropertyValue) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxonomyPropertyValue) IsSet() bool {
	return v.isSet
}
...
func NewNullableTaxonomyPropertyValue(val *TaxonomyPropertyValue) *NullableTaxonomyPropertyValue {
	return &NullableTaxonomyPropertyValue{value: val, isSet: true}
}
