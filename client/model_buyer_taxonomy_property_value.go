...
// checks if the BuyerTaxonomyPropertyValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuyerTaxonomyPropertyValue{}
...
type _BuyerTaxonomyPropertyValue BuyerTaxonomyPropertyValue
...
func NewBuyerTaxonomyPropertyValue() *BuyerTaxonomyPropertyValue {
	this := BuyerTaxonomyPropertyValue{}
	return &this
}
...
type NullableBuyerTaxonomyPropertyValue struct {
	value *BuyerTaxonomyPropertyValue
	isSet bool
}

func (v NullableBuyerTaxonomyPropertyValue) Get() *BuyerTaxonomyPropertyValue {
	return v.value
}

func (v *NullableBuyerTaxonomyPropertyValue) Set(val *BuyerTaxonomyPropertyValue) {
	v.value = val
	v.isSet = true
}

func (v NullableBuyerTaxonomyPropertyValue) IsSet() bool {
	return v.isSet
}

func (v *NullableBuyerTaxonomyPropertyValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBuyerTaxonomyPropertyValue(val *BuyerTaxonomyPropertyValue) *NullableBuyerTaxonomyPropertyValue {
	return &NullableBuyerTaxonomyPropertyValue{value: val, isSet: true}
}
