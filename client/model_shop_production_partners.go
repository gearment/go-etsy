...
// checks if the ShopProductionPartners type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopProductionPartners{}
...
type _ShopProductionPartners ShopProductionPartners
...
type NullableShopProductionPartners struct {
	value *ShopProductionPartners
	isSet bool
}

func (v NullableShopProductionPartners) Get() *ShopProductionPartners {
	return v.value
}

func (v *NullableShopProductionPartners) Set(val *ShopProductionPartners) {
	v.value = val
	v.isSet = true
}

func (v NullableShopProductionPartners) IsSet() bool {
	return v.isSet
}
...
func NewNullableShopProductionPartners(val *ShopProductionPartners) *NullableShopProductionPartners {
	return &NullableShopProductionPartners{value: val, isSet: true}
}
