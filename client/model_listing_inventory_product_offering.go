...
// checks if the ListingInventoryProductOffering type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListingInventoryProductOffering{}
...
type _ListingInventoryProductOffering ListingInventoryProductOffering
...
func NewListingInventoryProductOffering() *ListingInventoryProductOffering {
	this := ListingInventoryProductOffering{}
	return &this
}
...
type NullableListingInventoryProductOffering struct {
	value *ListingInventoryProductOffering
	isSet bool
}

func (v NullableListingInventoryProductOffering) Get() *ListingInventoryProductOffering {
	return v.value
}

func (v *NullableListingInventoryProductOffering) Set(val *ListingInventoryProductOffering) {
	v.value = val
	v.isSet = true
}

func (v NullableListingInventoryProductOffering) IsSet() bool {
	return v.isSet
}

func (v *NullableListingInventoryProductOffering) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListingInventoryProductOffering(val *ListingInventoryProductOffering) *NullableListingInventoryProductOffering {
	return &NullableListingInventoryProductOffering{value: val, isSet: true}
}
