...
func (r ShopListingVideoAPIDeleteListingVideoRequest) Execute() (*http.Response, error) {
...
func (a *ShopListingVideoAPIService) DeleteListingVideoExecute(r ShopListingVideoAPIDeleteListingVideoRequest) (*http.Response, error) {
	var (
...
func (r ShopListingVideoAPIGetListingVideoRequest) Execute() (*ListingVideo, *http.Response, error) {
...
Retrieves a single video associated with the given listing. Requesting a video from a listing returns an empty result.
	...
	@return ShopListingVideoAPIGetListingVideoRequest
*/
func (a *ShopListingVideoAPIService) GetListingVideo(ctx context.Context, videoId int64, listingId int64) ShopListingVideoAPIGetListingVideoRequest {
	return ShopListingVideoAPIGetListingVideoRequest{
		ApiService: a,
		ctx:        ctx,
		videoId:    videoId,
...
//
//	@return ListingVideo
func (a *ShopListingVideoAPIService) GetListingVideoExecute(r ShopListingVideoAPIGetListingVideoRequest) (*ListingVideo, *http.Response, error) {
	var (
...
func (r ShopListingVideoAPIGetListingVideosRequest) Execute() (*ListingVideos, *http.Response, error) {
...
Retrieves all listing video resources for a listing with a specific listing ID.
	...
	@return ShopListingVideoAPIGetListingVideosRequest
*/
func (a *ShopListingVideoAPIService) GetListingVideos(ctx context.Context, listingId int64) ShopListingVideoAPIGetListingVideosRequest {
	return ShopListingVideoAPIGetListingVideosRequest{
		ApiService: a,
		ctx:        ctx,
		listingId:  listingId,
...
//
//	@return ListingVideos
func (a *ShopListingVideoAPIService) GetListingVideosExecute(r ShopListingVideoAPIGetListingVideosRequest) (*ListingVideos, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ShopListingVideoAPIUploadListingVideoRequest) VideoId(videoId int64) ShopListingVideoAPIUploadListingVideoRequest {
	r.videoId = &videoId
	return r
}

// A video file to upload.
func (r ShopListingVideoAPIUploadListingVideoRequest) Video(video *os.File) ShopListingVideoAPIUploadListingVideoRequest {
	r.video = video
	return r
}

// The file name string for the video to upload.
func (r ShopListingVideoAPIUploadListingVideoRequest) Name(name string) ShopListingVideoAPIUploadListingVideoRequest {
	r.name = &name
	return r
}

func (r ShopListingVideoAPIUploadListingVideoRequest) Execute() (*ListingVideo, *http.Response, error) {
...
Uploads a new video for a listing, or associates an existing video with a specific listing. You must either provide the `video_id` of an existing video, or the name and binary file data for a video to upload.
	...
	@return ShopListingVideoAPIUploadListingVideoRequest
*/
func (a *ShopListingVideoAPIService) UploadListingVideo(ctx context.Context, shopId int64, listingId int64) ShopListingVideoAPIUploadListingVideoRequest {
	return ShopListingVideoAPIUploadListingVideoRequest{
		ApiService: a,
		ctx:        ctx,
		shopId:     shopId,
...
//
//	@return ListingVideo
func (a *ShopListingVideoAPIService) UploadListingVideoExecute(r ShopListingVideoAPIUploadListingVideoRequest) (*ListingVideo, *http.Response, error) {
	var (
