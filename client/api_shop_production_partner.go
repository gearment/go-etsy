...
func (r ShopProductionPartnerAPIGetShopProductionPartnersRequest) Execute() (*ShopProductionPartners, *http.Response, error) {
	return r.ApiService.GetShopProductionPartnersExecute(r)
}
...
Retrieves a list of production partners available in the specific Etsy shop identified by its shop ID.
	...
	@return ShopProductionPartnerAPIGetShopProductionPartnersRequest
*/
func (a *ShopProductionPartnerAPIService) GetShopProductionPartners(ctx context.Context, shopId int64) ShopProductionPartnerAPIGetShopProductionPartnersRequest {
	return ShopProductionPartnerAPIGetShopProductionPartnersRequest{
		ApiService: a,
		ctx:        ctx,
		shopId:     shopId,
...
//
//	@return ShopProductionPartners
func (a *ShopProductionPartnerAPIService) GetShopProductionPartnersExecute(r ShopProductionPartnerAPIGetShopProductionPartnersRequest) (*ShopProductionPartners, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ShopProductionPartners
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ShopProductionPartnerAPIService.GetShopProductionPartners")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/application/shops/{shop_id}/production-partners"
