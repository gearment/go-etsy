...
// checks if the ListingVariationImages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListingVariationImages{}
...
type _ListingVariationImages ListingVariationImages
...
type NullableListingVariationImages struct {
	value *ListingVariationImages
	isSet bool
}

func (v NullableListingVariationImages) Get() *ListingVariationImages {
	return v.value
}

func (v *NullableListingVariationImages) Set(val *ListingVariationImages) {
	v.value = val
	v.isSet = true
}

func (v NullableListingVariationImages) IsSet() bool {
	return v.isSet
}
...
func NewNullableListingVariationImages(val *ListingVariationImages) *NullableListingVariationImages {
	return &NullableListingVariationImages{value: val, isSet: true}
}
