...
// checks if the ListingImages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListingImages{}
...
type _ListingImages ListingImages
...
func (v NullableListingImages) Get() *ListingImages {
	return v.value
}
...
func NewNullableListingImages(val *ListingImages) *NullableListingImages {
	return &NullableListingImages{value: val, isSet: true}
}
