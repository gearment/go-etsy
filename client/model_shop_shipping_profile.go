...
type _ShopShippingProfile ShopShippingProfile
...
func NewShopShippingProfile() *ShopShippingProfile {
	...
	var profileType ShopShippingProfileProfileType = SHOPSHIPPINGPROFILEPROFILETYPE_MANUAL
...
func (o *ShopShippingProfile) GetProfileType() ShopShippingProfileProfileType {
	if o == nil || IsNil(o.ProfileType) {
		var ret ShopShippingProfileProfileType
		return ret
	}
