...
// checks if the ShopReceipts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopReceipts{}
...
type _ShopReceipts ShopReceipts
...
func (v NullableShopReceipts) Get() *ShopReceipts {
	return v.value
}
...
func NewNullableShopReceipts(val *ShopReceipts) *NullableShopReceipts {
	return &NullableShopReceipts{value: val, isSet: true}
}
