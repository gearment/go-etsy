...
func (r ShopListingProductAPIGetListingProductRequest) Legacy(legacy bool) ShopListingProductAPIGetListingProductRequest {
	r.legacy = &legacy
	return r
}

func (r ShopListingProductAPIGetListingProductRequest) Execute() (*ListingInventoryProduct, *http.Response, error) {
	return r.ApiService.GetListingProductExecute(r)
}
...
Open API V3 endpoint to retrieve a ListingProduct by ID.
	...
	@return ShopListingProductAPIGetListingProductRequest
*/
func (a *ShopListingProductAPIService) GetListingProduct(ctx context.Context, listingId int64, productId int64) ShopListingProductAPIGetListingProductRequest {
	return ShopListingProductAPIGetListingProductRequest{
		ApiService: a,
		ctx:        ctx,
		listingId:  listingId,
...
//
//	@return ListingInventoryProduct
func (a *ShopListingProductAPIService) GetListingProductExecute(r ShopListingProductAPIGetListingProductRequest) (*ListingInventoryProduct, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListingInventoryProduct
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ShopListingProductAPIService.GetListingProduct")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/application/listings/{listing_id}/inventory/products/{product_id}"
