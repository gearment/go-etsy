...
func main() {
	...
	listingImageId := int64(789) // int64 | The numeric ID of the primary [listing image](/documentation/reference#tag/ShopListing-Image) for this transaction.
...
func main() {
	...
	listingImageId := int64(789) // int64 | The numeric ID of the primary [listing image](/documentation/reference#tag/ShopListing-Image) for this transaction. (optional)
	...
	altText := "altText_example" // string | Alt text for the listing image. Max length 500 characters. (optional) (default to "")
 ...
 **altText** | **string** | Alt text for the listing image. Max length 500 characters. | [default to &quot;&quot;]
