...
func (o *ShopReceipt) GetFirstLine() string {
	if o == nil || IsNil(o.FirstLine.Get()) {
		var ret string
		return ret
	}
	return *o.FirstLine.Get()
}
...
func (o *ShopReceipt) GetPaymentEmail() string {
	if o == nil || IsNil(o.PaymentEmail.Get()) {
		var ret string
		return ret
	}
	return *o.PaymentEmail.Get()
}
...
// GetGiftSenderOk returns a tuple with the GiftSender field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ShopReceipt) GetGiftSenderOk() (*string, bool) {
	if o == nil || IsNil(o.GiftSender) {
		return nil, false
	}
	return o.GiftSender, true
}
...
func (o *ShopReceipt) GetTransactions() []ShopReceiptTransaction {
	if o == nil || IsNil(o.Transactions) {
		var ret []ShopReceiptTransaction
		return ret
	}
...
func (o ShopReceipt) ToMap() (map[string]interface{}, error) {
	...
	if o.FirstLine.IsSet() {
		toSerialize["first_line"] = o.FirstLine.Get()
	}
	...
	if o.FormattedAddress.IsSet() {
		toSerialize["formatted_address"] = o.FormattedAddress.Get()
	}
	...
	if o.PaymentEmail.IsSet() {
		toSerialize["payment_email"] = o.PaymentEmail.Get()
	}
	...
	if !IsNil(o.GiftSender) {
		toSerialize["gift_sender"] = o.GiftSender
	}
