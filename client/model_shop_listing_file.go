...
// checks if the ShopListingFile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopListingFile{}
...
type _ShopListingFile ShopListingFile
...
type NullableShopListingFile struct {
	value *ShopListingFile
	isSet bool
}

func (v NullableShopListingFile) Get() *ShopListingFile {
	return v.value
}

func (v *NullableShopListingFile) Set(val *ShopListingFile) {
	v.value = val
	v.isSet = true
}
...
func NewNullableShopListingFile(val *ShopListingFile) *NullableShopListingFile {
	return &NullableShopListingFile{value: val, isSet: true}
}
