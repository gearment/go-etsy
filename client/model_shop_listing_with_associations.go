...
type ShopListingWithAssociations struct {
	...
	Personalization      NullableEtsyModulesListingPersonalizationApiResourcesOpenApiListingPersonalization `json:"personalization,omitempty"`
...
func (o *ShopListingWithAssociations) SetFileDataNil() {
	o.FileData.Set(nil)
}
...
func (o *ShopListingWithAssociations) SetReadinessStateIdNil() {
...
func (o *ShopListingWithAssociations) SetSuggestedTitleNil() {
...
// GetPersonalization returns the Personalization field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ShopListingWithAssociations) GetPersonalization() EtsyModulesListingPersonalizationApiResourcesOpenApiListingPersonalization {
	if o == nil || IsNil(o.Personalization.Get()) {
		var ret EtsyModulesListingPersonalizationApiResourcesOpenApiListingPersonalization
		return ret
	}
	return *o.Personalization.Get()
}
...
// SetPersonalization gets a reference to the given NullableEtsyModulesListingPersonalizationApiResourcesOpenApiListingPersonalization and assigns it to the Personalization field.
func (o *ShopListingWithAssociations) SetPersonalization(v EtsyModulesListingPersonalizationApiResourcesOpenApiListingPersonalization) {
	o.Personalization.Set(&v)
}

// SetPersonalizationNil sets the value for Personalization to be an explicit nil
func (o *ShopListingWithAssociations) SetPersonalizationNil() {
	o.Personalization.Set(nil)
}
...
func (o ShopListingWithAssociations) ToMap() (map[string]interface{}, error) {
	...
	if o.Personalization.IsSet() {
		toSerialize["personalization"] = o.Personalization.Get()
	}
