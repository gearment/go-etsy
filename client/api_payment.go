...
func (r PaymentAPIGetPaymentAccountLedgerEntryPaymentsRequest) LedgerEntryIds(ledgerEntryIds []int64) PaymentAPIGetPaymentAccountLedgerEntryPaymentsRequest {
	r.ledgerEntryIds = &ledgerEntryIds
	return r
}

func (r PaymentAPIGetPaymentAccountLedgerEntryPaymentsRequest) Execute() (*Payments, *http.Response, error) {
...
func (a *PaymentAPIService) GetPaymentAccountLedgerEntryPaymentsExecute(r PaymentAPIGetPaymentAccountLedgerEntryPaymentsRequest) (*Payments, *http.Response, error) {
...

	{
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "ledger_entry_ids", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "ledger_entry_ids", t, "form", "multi")
		}
	}
...
func (r PaymentAPIGetPaymentsRequest) PaymentIds(paymentIds []int64) PaymentAPIGetPaymentsRequest {
	r.paymentIds = &paymentIds
	return r
}

func (r PaymentAPIGetPaymentsRequest) Execute() (*Payments, *http.Response, error) {
...
Retrieves a list of payments from a shop identified by `shop_id`. You can also filter results using a list of payment IDs.
	...
	@return PaymentAPIGetPaymentsRequest
*/
func (a *PaymentAPIService) GetPayments(ctx context.Context, shopId int64) PaymentAPIGetPaymentsRequest {
	return PaymentAPIGetPaymentsRequest{
		ApiService: a,
		ctx:        ctx,
		shopId:     shopId,
...
//
//	@return Payments
func (a *PaymentAPIService) GetPaymentsExecute(r PaymentAPIGetPaymentsRequest) (*Payments, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...

	{
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "payment_ids", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "payment_ids", t, "form", "multi")
		}
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r PaymentAPIGetShopPaymentByReceiptIdRequest) Execute() (*Payments, *http.Response, error) {
