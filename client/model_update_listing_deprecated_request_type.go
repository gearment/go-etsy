...
var AllowedUpdateListingDeprecatedRequestTypeEnumValuesValidator = map[interface{}]struct{}{
	UpdateListingDeprecatedRequestType("physical").Ptr().generateNormalizedEnum(): struct{}{},
	UpdateListingDeprecatedRequestType("download").Ptr().generateNormalizedEnum(): struct{}{},
	UpdateListingDeprecatedRequestType("both").Ptr().generateNormalizedEnum():     struct{}{},
}

func (v *UpdateListingDeprecatedRequestType) generateNormalizedEnum() any {
	if v == nil {
		return nil
	}
...
func (v *UpdateListingDeprecatedRequestType) UnmarshalJSON(src []byte) error {
	...
	if _, existing := AllowedUpdateListingDeprecatedRequestTypeEnumValuesValidator[enumTypeValue.Ptr().generateNormalizedEnum()]; existing {
		*v = enumTypeValue
		return nil
	}
