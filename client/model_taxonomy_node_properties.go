...
// checks if the TaxonomyNodeProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaxonomyNodeProperties{}
...
type _TaxonomyNodeProperties TaxonomyNodeProperties
...
type NullableTaxonomyNodeProperties struct {
	value *TaxonomyNodeProperties
	isSet bool
}

func (v NullableTaxonomyNodeProperties) Get() *TaxonomyNodeProperties {
	return v.value
}

func (v *NullableTaxonomyNodeProperties) Set(val *TaxonomyNodeProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxonomyNodeProperties) IsSet() bool {
	return v.isSet
}
...
func NewNullableTaxonomyNodeProperties(val *TaxonomyNodeProperties) *NullableTaxonomyNodeProperties {
	return &NullableTaxonomyNodeProperties{value: val, isSet: true}
}
