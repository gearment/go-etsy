...
Check to confirm connectivity to the Etsy API with an application
	...
	@return OtherAPIPingRequest
*/
func (a *OtherAPIService) Ping(ctx context.Context) OtherAPIPingRequest {
	return OtherAPIPingRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *OtherAPIService) PingExecute(r OtherAPIPingRequest) (*Pong, *http.Response, error) {
	var (
		...
		formFiles           []formFile
		localVarReturnValue *Pong
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OtherAPIService.Ping")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/application/openapi-ping"
...
func (r OtherAPITokenScopesRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.TokenScopesExecute(r)
}
...
Check the scopes of the provided token
	...
	@return OtherAPITokenScopesRequest
*/
func (a *OtherAPIService) TokenScopes(ctx context.Context) OtherAPITokenScopesRequest {
	return OtherAPITokenScopesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *OtherAPIService) TokenScopesExecute(r OtherAPITokenScopesRequest) (map[string]interface{}, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OtherAPIService.TokenScopes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v3/application/scopes"
