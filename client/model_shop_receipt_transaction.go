...
// checks if the ShopReceiptTransaction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShopReceiptTransaction{}
...
type _ShopReceiptTransaction ShopReceiptTransaction
...
type NullableShopReceiptTransaction struct {
	value *ShopReceiptTransaction
	isSet bool
}

func (v NullableShopReceiptTransaction) Get() *ShopReceiptTransaction {
	return v.value
}

func (v *NullableShopReceiptTransaction) Set(val *ShopReceiptTransaction) {
	v.value = val
	v.isSet = true
}

func (v NullableShopReceiptTransaction) IsSet() bool {
	return v.isSet
}
...
func NewNullableShopReceiptTransaction(val *ShopReceiptTransaction) *NullableShopReceiptTransaction {
	return &NullableShopReceiptTransaction{value: val, isSet: true}
}
