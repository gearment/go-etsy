...
// checks if the PaymentAccountLedgerEntries type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentAccountLedgerEntries{}
...
type _PaymentAccountLedgerEntries PaymentAccountLedgerEntries
...
func NewPaymentAccountLedgerEntries() *PaymentAccountLedgerEntries {
	this := PaymentAccountLedgerEntries{}
	return &this
}
...
func (o *PaymentAccountLedgerEntries) GetResults() []PaymentAccountLedgerEntry {
	if o == nil || IsNil(o.Results) {
		var ret []PaymentAccountLedgerEntry
		return ret
	}
	return o.Results
}
...
type NullablePaymentAccountLedgerEntries struct {
	value *PaymentAccountLedgerEntries
	isSet bool
}

func (v NullablePaymentAccountLedgerEntries) Get() *PaymentAccountLedgerEntries {
	return v.value
}

func (v *NullablePaymentAccountLedgerEntries) Set(val *PaymentAccountLedgerEntries) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentAccountLedgerEntries) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentAccountLedgerEntries) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentAccountLedgerEntries(val *PaymentAccountLedgerEntries) *NullablePaymentAccountLedgerEntries {
	return &NullablePaymentAccountLedgerEntries{value: val, isSet: true}
}
